...
\begin{proof}\leanok Immediate from \Cref{relabeled-entropy}.
\end{proof}
...
\begin{proof}\leanok Immediate from \Cref{relabeled-entropy-cond} and \Cref{chain-rule}.
\end{proof}
...
\begin{proof}\leanok This follows from \Cref{sumset-lower-gen} by conditioning to $Z = z$ and summing over $z$ (weighted by $\bbP[Z=z]$).
\end{proof}
...
\begin{proof}\leanok Immediate from Definitions \ref{ruz-dist-def} and \Cref{copy-ent}.
\end{proof}
...
\begin{proof} \leanok Immediate from \Cref{ruz-dist-def} and Lemmas \ref{relabeled-entropy}, \ref{copy-ent}.
\end{proof}
...
\begin{proof} \leanok Immediate from \Cref{neg-ent} and \Cref{ruz-dist-def}.
\end{proof}
...
\begin{proof} \leanok Immediate from \Cref{sumset-lower} and \Cref{ruz-dist-def}, and also \Cref{neg-ent}.
\end{proof}
...
\begin{proof}\leanok By \Cref{ruz-copy} and Lemmas \ref{independent-exist}, \ref{ruz-indep}, it suffices to prove this inequality assuming that $X,Y,Z$ are defined on the same space and are independent.  But then the claim follows from \Cref{ruzsa-triangle-improved} and \Cref{ruz-dist-def}.
\end{proof}
...
\begin{proof}\leanok Straightforward thanks to \Cref{copy-ent}, \Cref{ruz-copy}, \Cref{ruz-indep}, \Cref{cond-dist-def}, \Cref{conditional-entropy-def}.
\end{proof}
