...
\begin{lemma}
\uses{defn:nat-iso, defn:isomorphism}
...
\begin{defn}
\uses{defn:functor, defn:isomorphism}
\label{defn:ess-surj}
...
\begin{propn}
\uses{defn:ess-surj, defn:full-faithful, defn:eqv}
...
\begin{cor}
\uses{defn:full-faithful, defn:subcategory}
\label{cor:ff-emb}
