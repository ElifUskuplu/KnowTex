...
\begin{defn}
\uses{defn:category, defn:functor, defn:nat-iso}
\label{defn:adjn}
...
\begin{lemma}
\uses{defn:init-term, defn:isomorphism}
...
\begin{pf}
 \uses{lemma:unit-determines-adjn}
...
\begin{defn}
\uses{defn:category, defn:functor}
...
\begin{pf}\uses{thm:adj-triangle}
...
\begin{cor}
\uses{defn:adjn, defn:init-term, defn:comma-cat}
\label{cor:pre-AFT}
...
\begin{pf}\uses{lemma:adj-implies-init, thm:adj-comma}
